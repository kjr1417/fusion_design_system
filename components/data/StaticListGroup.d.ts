...
export interface StaticListGroupProps {
  ...
  rowGap?: string;
  /** When true, applies a spacing-300 bottom margin — use inside a form layout so the group spaces itself from the next field like other grouped controls. Default false. */
  formContext?: boolean;
