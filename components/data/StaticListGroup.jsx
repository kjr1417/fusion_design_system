...
export function StaticListGroup({
  ...
  if (columns > 1) {
    ...
    return (
      <div style={{ display: "flex", minWidth: 0, marginBottom, ...style }}>
  ...
  if (orientation === "horizontal") {
    return (
      <div style={{ display: "flex", flexWrap: "wrap", alignItems: "flex-start", minWidth: 0, marginBottom, ...style }}>
        {items.map((it, i) => (
  ...
  return <div style={{ minWidth: 0, marginBottom, ...style }}>{renderColumn(items, "i-")}</div>;
}
