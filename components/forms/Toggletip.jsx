...
export function Toggletip({ content, title, placement = "bottom", style }) {
  ...
  return (
    <span ref={ref} style={{ position: "relative", display: "inline-flex", verticalAlign: "middle", ...style }}>
      <button
        type="button"
      ...
      {open && (
        <span role="tooltip" style={{
          ...
          {title && <span style={{ fontWeight: "var(--salt-text-fontWeight-strong)" }}>{title}</span>}
          <span>{content}</span>
        </span>
      )}
    </span>
