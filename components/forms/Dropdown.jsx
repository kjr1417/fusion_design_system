...
export function Dropdown({ options = [], defaultValue, placeholder = "Select...", disabled = false, validationState, style, ...rest }) {
  ...
  return (
    <div className={cls} style={{ minWidth: 220, position: "relative", ...style }}>
      <select
        ...
        style={{ background: "none", border: "none", font: "inherit", color: "inherit", width: "100%", cursor: disabled ? "not-allowed" : "pointer", appearance: "none", WebkitAppearance: "none", paddingRight: isError ? 46 : 28 }}
        {...rest}
      >
